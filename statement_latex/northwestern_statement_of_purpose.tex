...
{I am fascinated by the endeavor to physically understand everything that
    ...
    protected from external effects in a scalable way in order to store and
    transmit information. Research projects at Northwestern that focus on
    circuit quantum electrodynamics and single photon computation are
    fascinating to me. I want to contribute to the efforts of understanding how
    tiny particles work and convincing them to behave in very particular
    ways in order to do something useful.  In addition to the inherent wonder
    of discovering how these systems behave under various circumstances and
    teasing order from chaos, pursuing a PhD at Northwestern will enable me to
    help furth the development of the field of quantum computing.
}
